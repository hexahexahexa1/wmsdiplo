-- ========================================
-- WMS Terminal Testing - Test Data Script (Fixed)
-- ========================================
...
DELETE FROM discrepancies WHERE task_id IN (SELECT id FROM tasks WHERE receipt_id IN (SELECT id FROM receipts WHERE doc_no LIKE 'ACT-TEST-%'));
...
-- ========================================
INSERT INTO zones (code, name, zone_type, is_active, description) 
VALUES ('TEST-RECEIVING-01', 'Test Receiving Zone', 'RECEIVING', true, 'Test receiving zone for terminal');

-- ========================================
-- 2. Create Test Locations in RECEIVING Zone
-- ========================================
INSERT INTO locations (code, zone_id, status, max_pallets, is_active, description)
SELECT 
    'TEST-RCV-001', 
    id, 
    'AVAILABLE', 
...
-- 3. Create Test SKUs
-- ========================================
INSERT INTO skus (code, name, is_active, description) 
VALUES 
...
-- ========================================
INSERT INTO pallets (code, status, is_active)
VALUES 
...
-- Task 4: IN_PROGRESS status, assigned to another user (should not appear in "My Tasks")
INSERT INTO tasks (task_type, status, receipt_id, line_id, assignee, assigned_by, qty_assigned, qty_done, created_at, started_at)
SELECT 
    'RECEIVING', 
    'IN_PROGRESS', 
